...
namespace Launchpad.Launcher
{
    internal partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            this.Text = "Soverance - " + Config.GetGameName();
            ...
            else
            {
                ...
                {
                    Stream iconStream = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("Launchpad.Launcher.Resources.orb.ico");
                    if (iconStream != null)
                    {
