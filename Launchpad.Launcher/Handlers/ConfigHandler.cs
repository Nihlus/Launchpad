...
namespace Launchpad.Launcher
{
    ...
    internal sealed class ConfigHandler
    {
		...
		public void Initialize()
		{
			...
			Version defaultLauncherVersion = new Version("1.0");
			...
			lock (ReadLock)
			{
				...
				if (!File.Exists(configPath))
				{
					...
					try
					{
						...
						data["Local"].AddKey("GameName", "Ethereal");
						...
						data["Remote"].AddKey("FTPUrl", "ftp://ftp.soverance.com");

						data["Launchpad"].AddKey("bOfficialUpdates", "false");
        ...
        public string GetGameExecutable()
        {
			...
			else
			{
                ...
                // String.Format(@"{0}{1}{3}Binaries{3}{2}{3}{1}.exe", 
